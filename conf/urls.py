...
urlpatterns = [
     ...
     url(r'parish/create/$', ParishCreateView.as_view(), name='parish_create'),
     url(r'parish/list/$', ParishListView.as_view(), name='parish_list'),
     url(r'parish/(?P<pk>[\w]+)/$', ParishUpdateView.as_view(), name='parish_edit'),
