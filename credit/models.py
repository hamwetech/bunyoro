...
class LoanRequest(models.Model):
    ...
    member = models.ForeignKey(CooperativeMember, on_delete=models.CASCADE, null=True, blank=True, related_name="member_loan_request")
    ...
    paid_amount = models.DecimalField(max_digits=12, decimal_places=2, default=0, null=True, blank=True)
